...
public class CountryForm {
	...
	private ContinentForm continentForm;
	...
	/**
	 * @return the continentForm
	 */
	public ContinentForm getContinentForm() {
		return continentForm;
	}

	/**
	 * @param continentForm
	 *            the continentForm to set
	 */
	public void setContinentForm(ContinentForm continentForm) {
		this.continentForm = continentForm;
	}
